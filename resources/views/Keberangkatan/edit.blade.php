...
@section('content')
<title>Edit :{{$keberangkatans2->kendaraans->plat_nomor}} </title>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('keberangkatan.index')}}">KEBERANGKATAN</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST"  action="{{route('keberangkatan.update', $keberangkatans2->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="plat_nomor" id="" class="form-control select2" required>
                                    ...
                                    @if ($keberangkatans2->id_kendaraan == $k->id)
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="penumpang" class="form-control" id="penumpang"
                                    value="{{$keberangkatans2->penumpang}}">
                                @error('penumpang')
                                <div class="text-danger mt-2">
                                    {{ $message }}
                                </div>
